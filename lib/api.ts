...
if (!API_BASE_URL) {
  throw new Error("NEXT_PUBLIC_API_BASE_URL is required. Set it to http://localhost:4000 for local development.");
}

const REQUIRED_API_BASE_URL: string = API_BASE_URL;
